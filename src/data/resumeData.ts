  ...
  previousCareers: [
    {
      ...
      period: "2019.07 ~ 2020.11 (1년 4개월)",
      description:
        "원자재 수급, 재고 관리, 출고 스케줄링 등 제조업 공급망(SCM) 실무를 담당. 협력사 발주·납기 조율부터 입고·검수·재고·출고 사이클까지 제조/영업 현장의 기초 물류 흐름을 직접 다루며, 부서 간 커뮤니케이션과 데이터 기반 의사결정 감각을 현장에서 체득. 광교 갤러리아 벽부등 개발 프로젝트에 SCM 담당으로 참여.",
    },
