...
export const youngmi = {
  profile: {
    name: "최용현",
    nameEn: "Choi Yong-hyun",
    role: "IT 기반 영업관리 · 운영 자동화(DX) 스페셜리스트",
    currentRole: {
      company: "Jigeumfilm (지금필름)",
      position: "Product Owner · 운영 시스템 구축",
      sinceISO: "2026-03-16",
      sinceLabel: "2026.03.16 ~",
    },
    tagline:
      "수기·엑셀 운영을 시스템으로 풀어, 사람은 영업 본연의 가치(고객·납기·관계)에 집중하게 만듭니다.",
    introduction: [
      "매출 1,034억 · 사원 55명 영미산업의 다음 50년 성장에 맞는 데이터 시스템을 구축하고, 영업 실무의 반복 업무(수주·출고·전표·ERP 입력)를 자동화해 1인당 운영 부담을 줄이는 것이 제 역할이라 생각합니다.",
      "지금필름에서 35명+ 작업자의 수주·배정·일정을 통합 관리하는 운영 어드민을 단독 설계·구축. 자동 매칭 엔진(정확도 97.6%)으로 휴먼 에러를 시스템 단에서 차단, 미매칭 65%↓ · 운영 처리 비용 70~80%↓의 수치 성과를 확보했습니다.",
      "동시성·데이터 정합성·부서별 권한 분리(RBAC)처럼 누락 시 곧장 휴먼 에러로 이어지는 디테일을 시스템 단에서 잡아냅니다.",
      "5,000+건 대량 데이터 처리 최적화, 결제 시스템 연동(포트원), 자동 매칭 엔진(정확도 97.6%) 같은 실 개발 자산을 영업관리 업무에 그대로 이식 가능 — 실적 집계 자동화, 미수금 트래킹, 휴먼 에러(오기입) 차단에 응용합니다.",
      "Excel 함수·피벗 활용에 능숙하며, 가톨릭대 IT 파이낸스 전공 지식으로 수금·전표·재무 데이터 흐름이 친숙합니다. 새 시스템·API 흡수 속도가 강점인 개발자 학습력으로 더존 ERP 기반의 매출·수주·출고 프로세스도 빠르게 흡수합니다.",
    ],
    email: "chldydgus777@kakao.com",
    socials: [
      { label: "Email", href: "mailto:chldydgus777@kakao.com" },
  ...
  experiences: [
    {
      company: "Jigeumfilm (지금필름)",
      role: "Product Owner · 운영 시스템 구축",
      period: "2026.03 ~ Present",
      duration: "약 2개월 (재직 중)",
      team: "대표 2명 · 영상·대본 작업자 35명+",
      serviceName: "영상 제작 운영 어드민",
      serviceDescription:
        "수기·엑셀·메신저로 흩어져 있던 35명+ 작업자의 수주·배정·일정 관리를 단일 시스템으로 통합. PO 의사결정과 AI 페어 프로그래밍을 결합해 단독 설계·구축.",
      stack: [
        "운영 프로세스 설계",
        "자동 매칭 로직",
        "데이터 정합성",
      ...
      highlights: [
        {
          title: "수기·엑셀 운영의 시스템화 (단독 설계·구축)",
          description:
            "엑셀 + 메신저로 흩어져 있던 35명+ 작업자 운영을 단일 어드민으로 통합. PO로서 업무 프로세스를 인터뷰·분석·재설계하고 AI 페어와 함께 직접 구현. 영미산업의 수기/엑셀 기반 운영을 시스템화하는 과제와 본질적으로 동일한 경험.",
          metrics: ["수기·엑셀 → 시스템화", "35명+ 운영 단일화"],
        },
        {
          title: "자동 매칭 엔진 — 휴먼 에러 시스템 차단",
          description:
            "수주 ↔ 작업자 ↔ 일정 매칭 로직 자체 설계. 사람이 일일이 맞추던 배정 작업을 자동화해 누락·중복 배정 같은 휴먼 에러를 데이터 입력 단에서 차단. 동일 패턴을 영미산업의 수주·출고·납기 매칭 / ERP 입력 검증에 그대로 이식 가능.",
          metrics: ["매칭 정확도 97.6%", "미매칭 65%↓"],
        },
        {
          title: "운영 처리 비용 70~80% 절감",
          description:
            "데이터 신선도 정책을 재정의하고 불필요한 동기화·중복 조회를 제거. 동일한 운영 데이터를 더 적은 리소스로 처리하도록 구조 최적화. 운영 인프라 비용을 수치로 검증된 절감.",
          metrics: ["처리 비용 70~80%↓", "운영 인프라 효율화"],
        },
      ],
    },
    {
      company: "(주) 커넥션스튜디오",
      role: "운영 시스템 / Front-end",
      period: "2024.09 ~ 2025.07",
      duration: "약 11개월",
      team: "백엔드 2명 · 디자이너 1명",
      serviceName: "캐스팅보트 — B2C 운영 플랫폼",
      serviceDescription:
      ...
      highlights: [
        {
          ...
          description:
            "고화질 프로필 이미지를 클라이언트에서 자동 압축·전송하도록 처리 파이프라인 구축. 운영자가 별도로 리사이즈하던 수작업 제거 + 서버 비용 절감.",
          metrics: ["8.1MB → 256KB (90%↓)", "4.19s → 111ms (37×↓)", "서버 비용 절감"],
        },
        {
          title: "대량 데이터(5,000+건) 처리 최적화",
          description:
            "5,000+건 프로필 데이터를 끊김 없이 조회·관리하도록 무한 스크롤 + 가상화 적용. 데이터가 늘어도 운영자 화면 응답성 유지 — 매출 1,000억대 기업의 누적 데이터 환경에 그대로 적용 가능한 패턴.",
          metrics: ["5,000+건 60fps 응답"],
        },
        {
          title: "B2C 결제·수익화 시스템 구축 — 첫 매출 달성",
          description:
            "외부 결제(웰컴페이) 연동 + 유료 멤버십 구독 비즈니스 모델 구현. 서비스 첫 매출의 결제·정산 흐름을 정합성 깨짐 없이 구축.",
          metrics: ["2025.01 서비스 첫 매출"],
        },
        {
          title: "MVP 2개월 시장 출시",
          description:
            "운영 시스템 구조를 빠르게 설계해 MVP를 2개월 내 시장 출시. 짧은 사이클로 비즈니스 가설을 검증하는 실전 환경에서 일한 경험.",
          metrics: ["MVP 2개월"],
        },
        {
          title: "오프라인 매니저 운영의 온라인화",
          description:
            "오프라인으로 주고받던 프로필 전달 업무를 온라인 워크플로우로 전환 — 매니저 운영 공수 감소.",
        },
        {
          title: "통합 운영 워크플로우 (단일 화면)",
          description:
            "스탭이 캐스팅 전 과정을 단일 화면에서 처리하도록 탭 기반 통합 어드민 설계. 화면 간 이동·중복 입력 같은 비효율 제거.",
        },
      ],
    },
    {
      company: "(주) 러브에그",
      role: "운영 어드민 / Front-end",
      period: "2023.09 ~ 2024.02",
      duration: "5개월",
      team: "백엔드 1명 · 디자이너 1명 · iOS 3명 · AOS 1명",
      ...
      highlights: [
        {
          ...
          description:
            "입점 신청·승인, 상품 등록·수정, 주문 관리(출고·교환·반품·취소), 계정 관리까지 운영자가 데이터를 한 화면에서 다루도록 어드민 구현. 영미산업 채용공고의 수주·출고·납기 관리 도메인과 직접 일치하는 실 경험.",
          metrics: ["출고/교환/반품/취소 통합", "JD 도메인 정합"],
        },
        {
          title: "통합 운영 어드민 (전사·상점별 권한 분리)",
          description:
            "전사 운영자용 통합 어드민과 상점별 어드민을 분리 구축. 정보 변경 이력 추적 + 상점별 상품·주문·계정 관리 — 부서/권한별 데이터 접근 분리(RBAC) 실무 경험. 영미산업의 부서 간 데이터 권한·정합성 관리에 즉시 활용 가능.",
          metrics: ["권한 분리 RBAC", "변경 이력 관리"],
        },
        {
          title: "결제·예약 시스템 연동",
          description:
            "포인트·쿠폰 할인 정책 반영, 결제 모듈·레저 예약 시스템 연동까지 구축. 돈·일정이 얽히는 운영 데이터를 정합성 보장하며 처리한 경험.",
        },
      ],
    },
    {
      company: "(주) 슬로그인",
      role: "예약·일정 시스템 / Front-end",
      period: "2022.06 ~ 2023.09",
      duration: "1년 3개월",
      team: "백엔드 1명",
      serviceName: "프라이빗 캠핑장 예약 시스템",
      serviceDescription:
        "예약·일정·결제까지 운영 사이클을 다루는 시스템의 초기 설계·구현.",
      stack: [
        "예약·일정 관리",
        "결제 모듈(포트원)",
        "다국어(i18n) 데이터",
      ...
      highlights: [
        {
          title: "예약·일정(납기) 관리 시스템",
          description:
            "캠핑장 등록·수정·삭제 + 예약·일정 관리 운영 기능 구현. PC·모바일 어디서나 운영자가 동일 데이터를 다루도록 반응형 UX 적용.",
          metrics: ["멀티 디바이스 운영"],
        },
        {
          title: "결제 모듈 연동",
          description:
            "나이스페이먼츠(포트원) 결제 연동 — 결제 데이터 정합성 확인 흐름 구축.",
        },
        {
          title: "다국어(i18n) 데이터 일관성",
          description:
            "다국어 시스템 구축 — 다양한 사용자가 동일한 운영 정보를 보도록 데이터 일관성 확보.",
        },
      ],
    },
    {
      company: "(주) 니더",
      role: "운영자 페이지 / Front-end",
      period: "2021.07 ~ 2021.12",
      duration: "5개월",
      stack: [
        "사장님(운영자) 페이지",
      ...
      highlights: [
        {
          ...
          description:
            "사업주가 직접 알바 구인 공고를 등록·수정·삭제하는 운영자 페이지 구현 — 외부 운영자가 데이터를 직접 관리하도록 흐름 설계한 경험.",
        },
        {
          title: "본인인증 연동",
          description:
            "휴대폰 본인인증 + 카카오 인증 연동 — 운영 데이터의 신원 정합성 확보.",
        },
        {
          title: "운영 시스템 구조 마이그레이션",
          description:
            "기존 코드 자산을 프레임워크 기반(Nuxt) 구조로 마이그레이션 — 유지보수성·확장성 개선.",
        },
      ],
    },
  ...
  previousCareers: [
    {
      ...
      period: "2019.07 ~ 2020.11 (1년 4개월)",
      description:
        "제조업 현장에서 SCM(공급망) 실무 경험 — 발주·납기·재고 데이터 관리, 협력사·내부 부서 간 커뮤니케이션. 광교 갤러리아 벽부등 프로젝트에 SCM으로 참여. 영미산업과 동일한 제조업 도메인의 운영 데이터 흐름을 직접 다뤄본 출발점.",
    },
