...
export const youngmi = {
  profile: {
    ...
    introduction: [
      ...
      "지금필름에서 35명 이상 운영 인력의 담당 배정·일정을 통합 관리하는 시스템을 단독 기획, 구축했습니다. 자동 매칭 로직 설계로 휴먼 에러를 차단하고, 데이터 신선도 정책 재정의로 클라우드 인프라 비용을 절감했습니다. 이 자산(대량 데이터 처리, 결제 모듈 연동 등)을 실적 집계·미수금 트래킹·오기입 차단에 그대로 응용할 수 있습니다.",
    ],
    email: "chldydgus777@kakao.com",
    socials: [
      { label: "Email", href: "mailto:chldydgus777@kakao.com" },
  ...
  previousCareers: [
    {
      ...
      period: "2019.07 ~ 2020.11 (1년 4개월)",
      description:
        "LED 조명 제품 개발과 함께 원자재 수급, 재고 관리, 출고 스케줄링 등 제조업 공급망(SCM) 실무를 담당. 협력사 발주·납기 조율부터 입고·검수·재고·출고 사이클까지 제조/영업 현장의 기초 물류 흐름을 직접 다루며, 부서 간 커뮤니케이션과 데이터 기반 의사결정 감각을 현장에서 체득. 광교 갤러리아 벽부등 개발 프로젝트에 SCM 담당으로 참여.",
    },
