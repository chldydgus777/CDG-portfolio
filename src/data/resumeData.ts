...
export const youngmi = {
  profile: {
    ...
    introduction: [
      ...
      "프론트·백엔드 로직 설계 경험을 바탕으로 Excel 함수는 물론 VBA·매크로를 활용한 수기 데이터 자동화에 즉시 투입 가능합니다. DB(MySQL 등) 쿼리 작성 능력과 프론트엔드 데이터 시각화 역량으로 Power BI 대시보드 구축 및 전사 데이터 정합성 관리에 빠르게 적응합니다. 새 시스템·API 흡수 속도가 강점인 개발자 학습력으로 더존 ERP 기반의 매출·수주·출고 프로세스 또한 즉각 흡수 가능합니다.",
    ],
    email: "chldydgus777@kakao.com",
    socials: [
      { label: "Email", href: "mailto:chldydgus777@kakao.com" },
