...
export const youngmi = {
  profile: {
    ...
    introduction: [
      ...
      "Excel 함수·피벗 활용에 능숙하고, 가톨릭대 IT 파이낸스 전공으로 수금·전표·재무 데이터 흐름이 친숙합니다. DB와 시스템 아키텍처에 대한 이해를 바탕으로 더존 ERP 등 신규 솔루션에도 빠르게 적응합니다.",
    ],
    email: "chldydgus777@kakao.com",
    socials: [
      { label: "Email", href: "mailto:chldydgus777@kakao.com" },
  ...
  experiences: [
    {
      ...
      serviceDescription:
        "35명 이상의 수주·배정·일정을 통합 관리하는 어드민. 요구사항 기획부터 구축·배포까지 1인 주도.",
      stack: [
        "프로세스 기획",
        "자동 매칭 로직",
        "데이터 정합성",
      ...
      highlights: [
        {
          title: "수기·엑셀 업무의 시스템화",
          description:
            "엑셀·메신저로 분산된 35명 이상의 데이터를 단일 어드민으로 통합. 업무 프로세스 분석부터 시스템 구축까지 1인 주도, 수기 입력·전달 공수 제거.",
          metrics: ["수기·엑셀 → 시스템화", "35명+ 단일화"],
        },
        {
