...
export const profile: Profile = {
  ...
  introduction: [
    "코드 구현부터 PO 의사결정까지 직접 책임. 지금필름에서 제작 운영 어드민과 자사 판매몰을 단독 구축·운영하고 세 번째 제품을 개발 중이며, 프론트엔드에서 시작해 백엔드와 인프라까지 범위를 넓혔습니다.",
...
export const experiences: Experience[] = [
  {
    ...
    team: "대표 2명 · 영상·대본 작업자 26명",
    serviceName: "지금필름 어드민 · 자사몰 · 신규 아카이브 서비스",
    serviceDescription:
      "제작 운영·판매 제품 2종을 구축·운영 중이며, 세 번째 제품(아카이브 서비스)을 개발 중. 프론트엔드부터 백엔드·인프라까지 전 구간 담당.",
    stack: [
      "React 19",
      "Next.js 15",
      "Vite",
...
export const devHeroStats: HeroStat[] = [
  { value: "3개", label: "단독 구축 — 운영 2 · 개발 중 1" },
...
export const po = {
  profile: {
    ...
    introduction: [
      "지금필름 PO로 제작 운영 어드민과 자사 판매몰을 스펙 정의부터 출시·운영까지 단독 수행하고, 세 번째 제품을 개발 중입니다. 기획서가 아니라 동작하는 제품으로 말합니다.",
  ...
  experiences: [
    {
      ...
      serviceName: "지금필름 어드민 · 자사몰 · 신규 아카이브 서비스",
      serviceDescription:
        "제작 운영·판매 제품 2종을 출시·운영 중이며, 세 번째 제품(아카이브 서비스)을 개발 중. 스펙 정의부터 단독 수행.",
      stack: [
        "제품 스펙 정의",
        "우선순위 결정",
        "수익화 설계",
      ...
      highlights: [
        {
          ...
          description:
            "수기·스프레드시트로 돌아가던 제작 운영을 어드민 제품으로 전환하고, 이어서 자사 판매몰을 열었습니다. 지금은 세 번째 제품을 개발 중입니다. 요구사항 수집·스펙·우선순위·출시·운영을 모두 단독으로 책임집니다.",
